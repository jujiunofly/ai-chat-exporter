/**
 * Shared inline SVG icons used across popup, options, and preview surfaces.
 */
...
/** Settings icon (compact gear used in the popup header) */
...
/** Settings icon (larger outline gear used in the options page hero) */
export const SettingsGearIcon = ({ size = 22 }: { size?: number }) => (
...
export const GithubChip = ({
  ...
  <a
    ...
    title={title}
  >
    <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: iconMarginRight }}>
